...
description: "Build a CEX token holdings dashboard for any on-chain token. Provide the token name, contract addresses, and exchange wallet addresses to auto-generate a data fetching script and interactive visualization dashboard. Use when tracking exchange holdings for stablecoins or any ERC20/TRC20/BEP20 token."
---
...
- `fetch_data.py` — 链上余额抓取脚本，支持 Tron / ETH / BNB 多链查询
